...
environment {
    PATH = "/opt/apache-maven-3.9.16/bin/./mvn:$PATH"
    (SONAR_TOKEN = credentials('SONAR_TOKEN'))
    AWS_REGION = 'us-east-1'
    S3_BUCKET = 'my-war-bucket'
    ECR_REPO = '291483628871.dkr.ecr.us-east-1.amazonaws.com/taxi-booking-app'
        ...
        stage('SonarQube Analysis') {
            steps {
                script {
                    ...
                    -Dsonar.projectKey=taxi-app5_taxi  \
                    -Dsonar.organization=taxi-app5 \
